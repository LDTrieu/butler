...
import (
	...
	repo "butler/application/domains/services/packing/repository"
	"context"
	"fmt"
...
func (s *service) GetById(ctx context.Context, id int64) (*models.Packing, error) {
...
func (s *service) GetOne(ctx context.Context, params *models.GetRequest) (*models.Packing, error) {
...
func (s *service) GetList(ctx context.Context, params *models.GetRequest) ([]*models.Packing, error) {
...
func (s *service) Update(ctx context.Context, obj *models.Packing) (*models.Packing, error) {
