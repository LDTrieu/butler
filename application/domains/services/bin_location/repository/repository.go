...
func (r *repo) GetById(ctx context.Context, id int64) (*models.BinLocation, error) {
	record := &models.BinLocation{}
...
func (r *repo) GetOne(ctx context.Context, params *models.GetRequest) (*models.BinLocation, error) {
	record := &models.BinLocation{}
...
func (r *repo) GetList(ctx context.Context, params *models.GetRequest) ([]*models.BinLocation, error) {
	records := []*models.BinLocation{}
	query := r.dbWithContext(ctx).Model(&models.BinLocation{})
	query = r.filter(query, params)
...
func (r *repo) Update(ctx context.Context, obj *models.BinLocation) (*models.BinLocation, error) {
	if obj.Id == 0 {
...
func (r *repo) filter(query *gorm.DB, params *models.GetRequest) *gorm.DB {
	...
	if params.IsAllowPickOrder != "" {
		if params.IsAllowPickOrder == "1" {
			allowPickOrder, _ := strconv.Atoi(params.IsAllowPickOrder)
			query = query.Where("allow_pick_order = ?", allowPickOrder)
		}
	}
	return query
}
